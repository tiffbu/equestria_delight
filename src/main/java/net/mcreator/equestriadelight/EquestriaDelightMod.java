package net.mcreator.equestriadelight;
...
@Mod("equestria_delight")
public class EquestriaDelightMod {
	public static final Logger LOGGER = LogManager.getLogger(EquestriaDelightMod.class);
	public static final String MODID = "equestria_delight";

	public EquestriaDelightMod() {
		...
		EquestriaDelightModTabs.REGISTRY.register(bus);
